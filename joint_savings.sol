...
contract JointSavings {
    // Two payable account addresses
    address payable accountOne;
    address payable accountTwo;

    // Address variable to keep track of who made the last withdrawal
    address public lastToWithdraw;

    // Two uint variables to keep track of the last withdrawal amount and the contract's balance
